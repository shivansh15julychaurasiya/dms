...
const Sidebar = () => {
  ...
  return (
    <>
      ...
      <div
        className={`position-fixed top-0 start-0 h-100 bg-light border-end shadow-sm ${isOpen ? "px-3" : "px-2"
          }`}
        style={{
      ...
      >
        ...
        <ul className="nav flex-column mt-4">
              ...
              <ul className="nav flex-column ms-3">
                ...
                {role === "ROLE_ADMIN" && (
                  <li className="nav-item">
                    <Link
                      to="/home/dashboard"
                      className={`nav-link px-2 text-dark sidebar-hover ${isActive("/home/dashboard")
                        ? "custom-active-link"
                        : ""
                        }`}
                    >
                ...
                {role === "ROLE_ECOURT" && (
                  <li className="nav-item">
                    <Link
                      ...
                      className={`nav-link px-2 text-dark sidebar-hover ${isActive("/home/ecourtdashboard")
                        ? "custom-active-link"
                        : ""
                        }`}
                    >
                ...
                <li className="nav-item">
                  <Link
                    to="/home/search"
                    className={`nav-link px-2 text-dark sidebar-hover ${isActive("/home/search")
                      ? "custom-active-link"
                      : ""
                      }`}
                  >
                ...
                {/* <li className="nav-item">
                  <Link
                    ...
                    className={`nav-link px-2 text-dark sidebar-hover ${isActive("/home/reservedcases")
                        ? "custom-active-link"
                        : ""
                      }`}
                  >
                ...
                <li className="nav-item">
                  <Link
                    ...
                    className={`nav-link px-2 text-dark sidebar-hover ${isActive("/cases_mgmt/status")
                        ? "custom-active-link"
                        : ""
                      }`}
                  >
          ...
          {/* Transaction Dropdown */}{role === "ROLE_ADMIN" && (
            <li className="nav-item">
              <div className="nav-link d-flex justify-content-between fw-bold align-items-center text-dark sidebar-hover">
                <div
                ...
                <ul className="nav flex-column ms-3">
                  <li className="nav-item">
                    <Link
                      ...
                      className={`nav-link px-2 text-dark sidebar-hover ${isActive("/casefile/casefileview")
                        ? "custom-active-link"
                        : ""
                        }`}
                    >
                  ...
                  <li className="nav-item">
                    <Link
                      to="/casefile/managebench"
                      className={`nav-link px-2 text-dark sidebar-hover ${isActive("/casefile/managebench")
                        ? "custom-active-link"
                        : ""
                        }`}
                    >
                  ...
                  <li className="nav-item">
                    <Link
                      ...
                      className={`nav-link px-2 text-dark sidebar-hover ${isActive("/home/managecauselist")
                        ? "custom-active-link"
                        : ""
                        }`}
                    >
                  ...
                  <li className="nav-item">
                    <Link
                      ...
                      className={`nav-link px-2 text-dark sidebar-hover ${isActive("/casefile/uploadmedia")
                        ? "custom-active-link"
                        : ""
                        }`}
                    >
          ...
          {/* Search Dropdown */}{role === "ROLE_ADMIN" && (
            <li className="nav-item">
              <div className="nav-link d-flex justify-content-between fw-bold align-items-center text-dark sidebar-hover">
                <div
              ...
              <ul className="nav flex-column ms-3">
                <li className="nav-item">
                  <Link
                    ...
                    className={`nav-link px-2 text-dark sidebar-hover ${isActive("/scheduling/court-calendar")
                      ? "custom-active-link"
                      : ""
                      }`}
                  >
                ...
                <li className="nav-item">
                  <Link
                    ...
                    className={`nav-link px-2 text-dark sidebar-hover ${isActive("/scheduling/hearing-schedule")
                      ? "custom-active-link"
                      : ""
                      }`}
                  >
                ...
                <li className="nav-item">
                  <Link
                    ...
                    className={`nav-link px-2 text-dark sidebar-hover ${isActive("/scheduling/set-appointment")
                      ? "custom-active-link"
                      : ""
                      }`}
                  >
