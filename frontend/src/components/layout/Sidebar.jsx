 ...
 const sidebarHoverStyle = (
  <style>
    {`
      ...
      .custom-active-link {
        background-color: #6610f2 !important; /* Bootstrap purple */
        color: #ffffff !important;
        border-radius: 5px;
        position: relative;
      }
      ...
      .sidebar-hover:hover::before {
        ...
        bottom: 10%;
        width: 4px;
        background-color: #e2b317ff; /* Bootstrap warning (orange-ish) */
        border-radius: 3px;
  ...
  return (
    <>
      ...
      <div
        className={`position-fixed top-0 start-0 h-100 bg-black border-end shadow-sm ${
          isOpen ? "px-3" : "px-2"
        }`}
        style={{
            ...
            <li className="nav-item">
              ...
              {activeDropdown === "List Of Case" && isOpen && (
                <ul className="nav flex-column ms-3">
                  <li className="nav-item">
                    <Link
                      to="/cause-lists/getCauseList/5"
                      className={`nav-link px-2 text-light sidebar-hover ${
                        isActive("/cause-lists/getCauseList/5")
                          ? "custom-active-link"
                          : ""
                      }`}
                    >
                  ...
                  <li className="nav-item">
                    <Link
                      to="/cause-lists/getCauseList/7"
                      className={`nav-link px-2 text-light sidebar-hover ${
                        isActive("/cause-lists/getCauseList/7")
                          ? "custom-active-link"
                          : ""
                      }`}
                    >
                  ...
                  <li className="nav-item">
                    <Link
                      to="/cause-lists/getCauseList/6"
                      className={`nav-link px-2 text-light sidebar-hover ${
                        isActive("/cause-lists/getCauseList/6")
                          ? "custom-active-link"
                          : ""
                      }`}
                    >
                  ...
                  <li className="nav-item">
                    <Link
                      to="/cause-lists/getCauseList/4"
                      className={`nav-link px-2 text-light sidebar-hover ${
                        isActive("/cause-lists/getCauseList/4")
                          ? "custom-active-link"
                          : ""
                      }`}
                    >
                  ...
                  <li className="nav-item">
                    <Link
                      to="/cause-lists/getCauseList/3"
                      className={`nav-link px-2 text-light sidebar-hover ${
                        isActive("/cause-lists/getCauseList/3")
                          ? "custom-active-link"
                          : ""
                      }`}
                    >
                  ...
                  <li className="nav-item">
                    <Link
                      to="/cause-lists/getCauseList/1"
                      className={`nav-link px-2 text-light sidebar-hover ${
                        isActive("/cause-lists/getCauseList/1")
                          ? "custom-active-link"
                          : ""
                      }`}
                    >
                  ...
                  <li className="nav-item">
                    <Link
                      to="/cause-lists/getCauseList/2"
                      className={`nav-link px-2 text-light sidebar-hover ${
                        isActive("/cause-lists/getCauseList/2")
                          ? "custom-active-link"
                          : ""
                      }`}
                    >
